...
data = data[,c(1:14)] #select columns in your dataset
...
targetdata_short = dat_sub[,c(1, # f.eid
                              ...
                              8:9, # dependent variables- BERT, CGT or FAGN summary measure
                              14,4:7)]    # covariates- age, sex, site, BMI 
no_fvar_long = NA
...
result.temp = UKB_lme_reg(targetdata_long,targetdata_short,
                          ...
                          vinteraction,1)
View(result.temp)
write.csv(result.temp, "results-serum_CGT_MDD_glm.csv") #save results as .csv file
