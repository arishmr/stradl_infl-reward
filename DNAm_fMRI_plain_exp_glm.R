...
targetdata_short = dat_sub[,c(1, # f.eid
                              ...
                              3:6, # dependent variables- BERT, CGT or FAGN summary measure
                              11,7:8)]    # covariates- age, sex, site, BMI 
no_fvar_long = NA
...
result.temp = UKB_lme_reg(targetdata_long,targetdata_short,
                          ...
                          vinteraction,1)
View(result.temp)
write.csv(result.temp, "results-DNAm_fMRI_plain_alcyest_glm.csv") #save results as .csv file
